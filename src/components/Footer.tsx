  ...
  return (
    <>
      <style>{`
        ...
        .footer-grid { display: grid; grid-template-columns: 2fr 1fr 1fr 1.5fr; gap: 4rem; text-align: center; justify-items: center; }

        .footer-brand .footer-logo { display: flex; align-items: center; justify-content: center; gap: 0.75rem; margin-bottom: 1.5rem; }
        .footer-logo-mark {
        ...
        .footer-brand p { font-size: 0.95rem; line-height: 1.7; color: rgba(255,255,255,.7); max-width: 300px; margin-left: auto; margin-right: auto; }

        .footer-socials { display: flex; justify-content: center; gap: 0.75rem; margin-top: 2rem; }
        .footer-social-link {
        ...
        .footer-contact-item { display: flex; flex-direction: column; align-items: center; gap: 0.35rem; margin-bottom: 1rem; }
        .footer-contact-icon { font-size: 1.1rem; flex-shrink: 0; color: var(--wfp-gold); }
